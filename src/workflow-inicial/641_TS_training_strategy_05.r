...
PARAM$final_train <- c(202010,202009,202008,202002,202001,
201912
)

PARAM$train$training <- c(202008,202002,202001,201912, 201911,
  201910
)

PARAM$train$validation <- c( 202009)
PARAM$train$testing <- c(  202010)

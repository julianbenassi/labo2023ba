...
archivo_salida <- "/home/julianbenassi013/Desktop/salida_grid/gridsearch_binaria1.txt"
...
for (vmax_depth in c(7,8)) {
  for (vmin_split in c(600,580,550,500,450)) {
    for(cp in c(-0.6)) {
        for(minbucket in c(100,120,140,160,180)) {
